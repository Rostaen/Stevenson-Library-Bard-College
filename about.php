...
<div class="container">
	...
	<div class="row">
		<div class="col-lg-4">
			...
			<ul>
				<a href="https://www.levyinstitute.org/">
					<li>The Levy Economics Institute Library (Annandale)</li>
				</a>
				<a href="https://ccs.bard.edu/research-center">
					<li>Center for Curatorial Studies Library (Annandale)</li>
				</a>
				<a href="https://www.bgc.bard.edu/research/library.html">
					<li>Bard Graduate Center for Studies in the Decorative Arts, Design and Culture Library (New York City)</li>
				</a>
			</ul>
		</div>
		<div class="col-lg-8">
